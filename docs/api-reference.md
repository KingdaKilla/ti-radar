...
- Entwicklung: `http://localhost:8001`
- Frontend-Proxy: Vite leitet `/api` und `/health` automatisch an `:8001` weiter

## Endpoints

### POST /api/v1/radar

Fuehrt alle fuenf Use Cases parallel aus und liefert ein komplettes Dashboard-Objekt.
...
```json
{
  ...
  "explainability": {
    ...
    "methods": ["FTS5-Volltextsuche", "CAGR ueber 8 Jahre", "HHI-Index", "Jaccard-Koeffizient"],
    "deterministic": true,
    "warnings": [],
    "query_time_ms": 51
  }
